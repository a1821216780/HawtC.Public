...
//
//    This file is part of OpenWECD.AeroL.Unified_momentum_model
//
...
{
    public class DySteadyBEM : CallDynamicAeroLoad
    {
        #region 字段
        private int nb_Load;
        private int BldNum;
        ...
        public DySteadyBEM(AeroL.AER_ParameterType p, MBD_ParameterType mp, WND_RtHndSideType wndrths)
        {
            nb_Load = p.BldNodes;
            BldNum = p.NumBl;
            ...
            LogHelper.WriteLog("Run BEMT.DySteadyBEM Unified Momentum Model to Solve！", title: "[success]", leval: 1);
        }
